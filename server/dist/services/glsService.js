...
class GlsService {
    ...
    async login(username, password, progressCallback) {
        try {
            ...
            await this.driver.wait(selenium_webdriver_1.until.urlContains('auth.dc.gls-group.eu'), 10000);
            ...
            const usernameSelectors = [
                selenium_webdriver_1.By.id('username'),
                selenium_webdriver_1.By.name('username'),
                selenium_webdriver_1.By.css('input[name="username"]'),
                selenium_webdriver_1.By.css('#username'),
                selenium_webdriver_1.By.css('input[type="text"]'),
                selenium_webdriver_1.By.css('input[placeholder*="Benutzer"]'),
                selenium_webdriver_1.By.css('input[placeholder*="User"]'),
                selenium_webdriver_1.By.css('input[placeholder*="Email"]'),
                selenium_webdriver_1.By.xpath('//input[@type="text" or @type="email"]')
            ];
            for (const selector of usernameSelectors) {
                try {
                    usernameField = await this.driver.wait(selenium_webdriver_1.until.elementLocated(selector), 500);
            ...
            await usernameField.sendKeys(selenium_webdriver_1.Key.ENTER);
            ...
            const passwordSelectors = [
                selenium_webdriver_1.By.id('password'),
                selenium_webdriver_1.By.name('password'),
                selenium_webdriver_1.By.css('input[name="password"]'),
                selenium_webdriver_1.By.css('#password'),
                selenium_webdriver_1.By.css('input[type="password"]'),
                selenium_webdriver_1.By.xpath('//input[@type="password"]')
            ];
            ...
            await passwordField.sendKeys(selenium_webdriver_1.Key.ENTER);
            ...
            if (loginSuccessful) {
                ...
                for (const selector of errorSelectors) {
                    try {
                        const errorElements = await this.driver.findElements(selenium_webdriver_1.By.css(selector));
    ...
    async trackPackage(trackingNumber, progressCallback) {
        try {
            ...
            await this.driver.wait(selenium_webdriver_1.until.elementLocated(selenium_webdriver_1.By.css('#txtTrackingNumber')), 100);
            ...
            // Wait for results
            await this.driver.wait(selenium_webdriver_1.until.elementLocated(selenium_webdriver_1.By.css('.tracking-results-table')), 100);
            ...
            await this.driver.wait(selenium_webdriver_1.until.elementLocated(selenium_webdriver_1.By.css('.tracking-events-table')), 100);
    ...
    async loadAllShipments(progressCallback) {
        try {
            if (!this.driver) {
                throw new Error('Driver not initialized. Please login first.');
            }
    ...
    async clickSearchButton() {
        try {
            ...
            const searchButtonSelectors = [
                selenium_webdriver_1.By.id('search'),
                selenium_webdriver_1.By.css('#search'),
                selenium_webdriver_1.By.css('button#search'),
                selenium_webdriver_1.By.css('input#search'),
                selenium_webdriver_1.By.css('[id="search"]'),
                selenium_webdriver_1.By.xpath('//button[@id="search"]'),
                selenium_webdriver_1.By.xpath('//input[@id="search"]'),
                selenium_webdriver_1.By.xpath('//*[@id="search"]')
            ];
            ...
            if (!searchButton) {
                ...
                const alternativeSelectors = [
                    ...
                    selenium_webdriver_1.By.css('input[type="submit"]'),
                    selenium_webdriver_1.By.css('.search-button'),
                    selenium_webdriver_1.By.css('.btn-search'),
                    selenium_webdriver_1.By.xpath('//button[contains(text(),"Search")]'),
                    selenium_webdriver_1.By.xpath('//button[contains(text(),"Suchen")]'),
                    selenium_webdriver_1.By.xpath('//input[@value="Search"]'),
                    selenium_webdriver_1.By.xpath('//input[@value="Suchen"]')
                ];
            ...
            if (searchButton) {
                ...
                const allButtons = await this.driver.findElements(selenium_webdriver_1.By.tagName('button'));
                const allInputs = await this.driver.findElements(selenium_webdriver_1.By.css('input[type="submit"], input[type="button"]'));
    ...
    async scrapeShipmentDetails(progressCallback) {
        ...
        try {
            ...
            for (const selector of specificSelectors) {
                try {
                    const elements = await this.driver.findElements(selenium_webdriver_1.By.css(selector));
            ...
            if (shipmentDetails.length === 0) {
                ...
                try {
                    const allNgClickLinks = await this.driver.findElements(selenium_webdriver_1.By.css('a[ng-click]'));
            ...
            if (shipmentDetails.length === 0) {
                ...
                try {
                    ...
                    const allNgElements = await this.driver.findElements(selenium_webdriver_1.By.css('[ng-click]'));
                    ...
                    const tables = await this.driver.findElements(selenium_webdriver_1.By.tagName('table'));
                    console.log(`📊 ${tables.length} Tabellen gefunden`);
                    const lists = await this.driver.findElements(selenium_webdriver_1.By.tagName('ul'));
    ...
    async extractShipmentDetails(trackingElement, trackingNumber) {
        ...
        try {
            ...
            for (let i = 0; i < 5; i++) {
                try {
                    parentRow = await parentRow.findElement(selenium_webdriver_1.By.xpath('..'));
            ...
            if (parentRow && (await parentRow.getTagName()).toLowerCase() === 'tr') {
                ...
                for (const selector of statusSelectors) {
                    try {
                        const statusElement = await parentRow.findElement(selenium_webdriver_1.By.xpath(selector));
                        if (statusElement) {
                ...
                for (const selector of recipientSelectors) {
                    try {
                        const recipientElements = await parentRow.findElements(selenium_webdriver_1.By.xpath(selector));
                ...
                for (const selector of dateSelectors) {
                    try {
                        const dateElements = await parentRow.findElements(selenium_webdriver_1.By.xpath(selector));
    ...
    async extractTextSafely(element, selector) {
        try {
            const foundElement = await element.findElement(selenium_webdriver_1.By.css(selector));
